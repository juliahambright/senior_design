...
print("*********Connecting to XBEE on USB0**********")
xbee = ZigBee(xbee_port)


xbee.tx(dest_addr="\xFF\xFF",data="HELLO FROM XBEE")
print("XBEE has sent Hello DATA")
...
while(1):
    ...
    #pipe.stop()
    print("*****Connection to Lidar on USB1*****")    
    ...
    if True:
        ...
        print("Waypoint Data Has been sent")
